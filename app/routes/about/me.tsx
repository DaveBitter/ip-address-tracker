...
const Me = () => {
    return <article>
        ...
        <p><a className='text-lg lg:text-2xl text-blue-600' href='https://davebitter.com' target='_blank'>Drop by my website for a collections of my talks, videos and articles covering a wide range of topics</a></p>
    </article>;
};
